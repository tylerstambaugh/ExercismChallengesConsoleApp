...
public class Authenticator
{
    ...
    public Identity Admin
    {
        get
        {
            return new Identity {Email = "admin@ex.ism", FacialFeatures = new FacialFeatures { EyeColor = "green",  PhiltrumWidth = 0.9m }, NameAndAddress = new List<string>() { "Chanakya", "Mumbai", "India" } };
        }
    }
